...
# Project:  qt.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile qt.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = qt1.0.0
DISTDIR = /Users/terashieishion/Desktop/project3/qt/.tmp/qt1.0.0
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/macx.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/sanitize.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/gcc-base.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/gcc-base-mac.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/clang.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/clang-mac.conf \
...
QMAKE_TARGET  = qt
DESTDIR       = 
TARGET        = qt.app/Contents/MacOS/qt
...
EXPORT__PRO_FILE_ = /Users/terashieishion/Desktop/project3/qt/qt.pro


include /opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

qt.app/Contents/MacOS/qt:  $(OBJECTS)  
	@test -d qt.app/Contents/MacOS/ || mkdir -p qt.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: qt.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/macx.conf \
...
qt.app/Contents/Info.plist: 
	...
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,test.qt,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},test.qt,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,qt,g" -e "s,@LIBRARY@,qt,g" -e "s,\$${EXECUTABLE_NAME},qt,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >qt.app/Contents/Info.plist

all: Makefile \
		qt.app/Contents/PkgInfo \
		qt.app/Contents/Info.plist qt.app/Contents/MacOS/qt
